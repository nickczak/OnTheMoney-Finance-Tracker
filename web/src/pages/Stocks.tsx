...
export default function Stocks() {
  ...
  const quoteColor = (change: number) => (change >= 0 ? "#36e65d" : "#ff5c5c");
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
          {indices.map((idx) => (
            <button
              ...
              className="rounded-[3px] bg-surface engraved p-4 text-left hover:border-brand/40 hover:bg-surface-2 transition-colors"
            >
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="p-2.5 rounded-lg hover:bg-surface-3 transition-colors"
                  aria-label={
      ...
      <div className="mt-8">
        ...
        {watchlist.length === 0 ? (
          ...
          watchlist.map((stock) => (
            <div
              key={stock.symbol}
              className="flex flex-row items-center rounded-[3px] bg-surface engraved p-3.5 mt-2 hover:border-brand/40 transition-colors"
            >
              <button
                type="button"
