...
function Field({
  ...
  return (
    <input
      className="w-full max-w-[320px] flex-1 bg-surface-alt text-text font-serif text-[15px] outline-none border border-border rounded-xl py-2.5 px-3 mb-3 placeholder:text-muted focus:border-brand"
      value={value}
...
function ProjLineChart({ result }: { result: Projection }) {
  ...
  const series = [
    { data: result.worst10Trajectory, color: "#d92d20" },
    { data: result.medianTrajectory, color: "#b54708" },
    { data: result.meanTrajectory, color: "#8a94a6" },
    { data: result.best10Trajectory, color: "#067647" },
  ];
  ...
  return (
    <div className="mt-4 mb-6">
      <div className="border border-border rounded-xl bg-surface-alt p-2 flex items-center">
  ...
  return (
    ...
    >
      <div className="p-4 pb-20">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-row justify-between gap-3 mb-2">
              <div className="flex-1 bg-surface border border-border rounded-2xl p-4">
                ...
                <div className="font-serif font-bold text-danger mt-1.5">
              ...
              <div className="flex-1 bg-surface border border-border rounded-2xl p-4">
                ...
                <div className="font-serif font-bold text-warning mt-1.5">
            ...
            <div className="flex flex-row justify-between gap-3 mb-2">
              <div className="flex-1 bg-surface border border-border rounded-2xl p-4">
                ...
                <div className="font-serif font-bold text-success mt-1.5">
              ...
              <div className="flex-1 bg-surface border border-border rounded-2xl p-4">
                ...
                <div className="font-serif font-bold text-text mt-1.5">
        ...
        <div
          className="bg-surface border border-border rounded-2xl shadow-sm p-5"
        ...
        >
          ...
          <button
            type="button"
            onClick={() => run()}
            className="w-full bg-brand text-white rounded-xl py-3 flex items-center justify-center hover:bg-brand-hover mt-4"
          >
            {loading ? (
